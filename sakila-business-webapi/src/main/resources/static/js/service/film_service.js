...
//			return $http.get('http://localhost:8080/getFilms/').then(
					return $http.get('http://127.0.0.1:8080/getFilms/').then(
					function(res){
...
//			return $http.get('http://localhost:8080/getRentalAndFilmByCustomerId/' + customerId).then(
			return $http.get('http://127.0.0.1:8080/getRentalAndFilmByCustomerId/' + customerId).then(
					function(res){
...
//			return  $http.post('http://localhost:8080/createFilm/', film).then(
					return  $http.post('http://127.0.0.1:8080/createFilm/', film).then(
					function(res){
...
//			return $http.post('http://localhost:8080/deleteFilm/' + id).then(
			return $http.post('http://127.0.0.1:8080/deleteFilm/' + id).then(
					function(res){
...
//			return $http.post('http://localhost:8080/updateFilm/', film).then(
			return $http.post('http://127.0.0.1:8080/updateFilm/', film).then(
